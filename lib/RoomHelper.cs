...
namespace YGOCore.Net
{
	...
	public static class RoomHelper
	{
		...
		#region player
		public static void OnPlayNameEvent(this GameServer server, StoSMessage msg,params string[] names){
		...
		public static void OnPlayEvent(this GameServer server, StoSMessage msg,params GameSession[] players){
